...
def email_notification(base_folder_email, destination_email_addresses, my_email_login, date_and_time_of_scrape, desired_scrape_date_literal):
    ...
    # GENERATE EMAIL HTML
    message = create_final_email_payload(base_folder_email, desired_scrape_date_literal, formatted_date, formatted_time, yesterday_date)

    # GENERATE SUBJECT LINE
    subject = create_subject_line(base_folder_email, desired_scrape_date_literal, formatted_date, yesterday_date)
